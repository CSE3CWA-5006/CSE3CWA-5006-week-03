...
# PostgreSQL + Prisma CRUD lab setup for Ubuntu only.
# This installs PostgreSQL, prepares the shared classroom database,
# installs npm dependencies, and generates the Prisma Client.

DB_NAME="university_db"
DB_USER="university_user"
DB_PASSWORD="123456"

echo "==> This lab uses Prisma ORM with PostgreSQL."
...
echo "==> Creating tables and sample dataset"
...
echo "==> Installing npm dependencies and generating Prisma Client"
...
This lab uses Prisma ORM CRUD methods:
